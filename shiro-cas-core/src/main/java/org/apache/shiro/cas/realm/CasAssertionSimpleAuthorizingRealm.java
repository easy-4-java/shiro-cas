 ...
 * the License.
 */
package org.apache.shiro.cas.realm;
...
import org.apache.shiro.cas.exception.CasTicketFoundException;
import org.apache.shiro.cas.token.CasAssertionAuthenticationToken;
import org.apache.shiro.cas.CasTicketValidatorUtils;
...
public class CasAssertionSimpleAuthorizingRealm extends AbstractAuthorizingRealm {
    ...
    private static final Logger log = LoggerFactory.getLogger(CasAssertionSimpleAuthorizingRealm.class);
